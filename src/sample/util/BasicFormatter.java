...
public class BasicFormatter {
    ...
    private static class FormatProcess {
        ...
        public String perform() {
            ...
            while (this.tokens.hasMoreTokens()) {
                ...
                if ((this.afterByOrSetOrFromOrSelect) && (",".equals(this.token))) {
                    ...
                    closeParen();
                } else if (BasicFormatter.BEGIN_CLAUSES.contains(this.lcToken)) {
                    beginNewClause();
                } else if (BasicFormatter.END_CLAUSES.contains(this.lcToken)) {
                    endNewClause();
        ...
        private static boolean isFunctionName(String tok) {
            ...
            return (isIdentifier) && (!BasicFormatter.LOGICAL.contains(tok))
                    && (!BasicFormatter.END_CLAUSES.contains(tok))
                    && (!BasicFormatter.QUANTIFIERS.contains(tok)) && (!BasicFormatter.DML.contains(tok))
                    && (!BasicFormatter.MISC.contains(tok));
        }
